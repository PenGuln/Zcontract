...
def deployHawk():
    ...
    hawk = Hawk.deploy(PourVerifier[-1], 
                       ...
                       WithdrawVerifier[-1],
                       account,
                       [13831938532176550324958139758445033250885452427288105901790261247373594399825, 
                        1069949356836057373242838462873732805967900060420173004808443205495245038966,
